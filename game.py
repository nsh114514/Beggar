...
son_label.place(anchor="center",relx=0.5,rely=0.3,height=60,width=140)
def singleplayer():
    import time
    time = time.time()
...
son_button1.place(anchor="center",relx=0.5,rely=0.4)
son_button2 = tkinter.Button(win,text="退出",command=quitgame)
son_button2.place(anchor="center",relx=0.55,rely=0.6)
time = time.time()
